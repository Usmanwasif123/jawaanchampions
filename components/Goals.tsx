  ...
  return (
    ...
    >
      ...
      <div className='flex lg:flex-row flex-col justify-center w-10/12 gap-0 items-center'> 
        ...
        <Image className='absolute z-30 xl:left-[9rem] lg:left-[1rem] md:left-[6rem]'
        src='/goals-sdgs.png'
        alt='goals-sdgs'
        width={400}
        height={400}
        />
          <Image
            ...
            width={600}
            height={1000}
            className='z-20 xl:mt-[0rem] xl:ml-[1rem] md:pb-7'
          />
        </div>
        <div className='z-20 flex-[1] flex flex-col items-center justify-center gap-12 w-full lg:w-0 h-[0rem]'>
        ...
        width={150}
        height={150}
        className='z-20 xl:mt-[-20rem] xl:ml-[20rem] lg:mt-[30rem]'
        />
        </div>
        ...
        width={250}
        height={250}
        className='z-20 xl:mt-[-15rem] xl:ml-[0rem] lg:mt-[-10rem]'
        />
        </div> 
        ...
        width={230}
        height={230}
        className='z-20 xl:mt-[-5rem] lg:mt-[-5rem]'
        />
        </div> 
        ...
        width={230}
        height={230}
        className='z-20 xl:mt-[-50rem] lg:mt-[-45rem]'
        />
        </div> 
        ...
        width={230}
        height={230}
        className='z-20 xl:mt-[-10rem] lg:mt-[-25rem]'
        />
        </div>
        ...
        width={230}
        height={230}
        className='z-20 xl:mt-[-7rem] lg:mt-[-10rem]'
        />
        </div> 
        <div className="flex justify-center items-center relative xl:ml-[12rem] lg:ml-[20rem]"
        data-aos="fade-left"
        data-aos-easing="ease-out-cubic"
        data-aos-duration="2000">
        <Image 
        ...
        width={230}
        height={230}
        className='z-20 xl:mt-[-40rem] lg:mt-[-30rem]'
        />
        </div> 
        ...
        width={230}
        height={230}
        className='z-20 xl:mt-[-15rem]  lg:mt-[-18rem]'
        />
        </div> 
        ...
        width={230}
        height={230}
        className='z-20 xl:mt-[-5rem] lg:mt-[-10rem]'
        />
        </div> 
